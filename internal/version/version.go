// Package version provides functionality for checking for Downloader updates via GitHub API.
package version
...
const (
	...
	GitHubAPIURL = "https://api.github.com/repos/DownloaderDM/Downloader/releases/latest"
...
func CheckForUpdate(currentVersion string) (*UpdateInfo, error) {
	...
	req.Header.Set("User-Agent", "Downloader-Update-Checker")
