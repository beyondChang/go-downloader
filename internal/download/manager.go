...
// ExecuteDownload is the main entry point for downloads executed by the Engine pool
func ExecuteDownload(ctx context.Context, cfg *types.DownloadConfig) error {
	start := time.Now()
